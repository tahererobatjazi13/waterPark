...
private fun AllocationStatusChip(
    ...
    val (text, bg, fg, icon) = when (status) {
        AllocationStatus.Delivered -> ir.kitgroup.hotel.feature.advertising.ui.collection.Quad(
        ...
        AllocationStatus.Pending -> ir.kitgroup.hotel.feature.advertising.ui.collection.Quad(
