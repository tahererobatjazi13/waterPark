    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        TextField(
            ...
            colors = TextFieldDefaults.colors(
                focusedTextColor = PartnerManagementTheme.colors.textPrimary,
                unfocusedTextColor = PartnerManagementTheme.colors.textPrimary,
                disabledTextColor = PartnerManagementTheme.colors.textSecondary,
