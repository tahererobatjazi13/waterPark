...
private val demoAllocations = listOf(
    Allocation("1", "محمد احمدی", "هتل پارسیان آزادی", "رومیزی", "stand", 5, "۱۴۰۳/۰۳/۲۲", AllocationStatus.Delivered),
    Allocation("2", "سارا مرادی", "هتل اسپیناس پالاس", "دیواری", "wall", 3, "۱۴۰۳/۰۳/۲۴", AllocationStatus.Pending),
    Allocation("3", "علی رضایی", "هتل هما", "کیوسک", "kiosk", 2, "۱۴۰۳/۰۳/۲۰", AllocationStatus.Delivered),
    Allocation("4", "نازنین کریمی", "هتل بزرگ تهران", "رومیزی", "stand", 4, "۱۴۰۳/۰۳/۲۵", AllocationStatus.Pending)
)
            ...
            Row(
                ...
                Column(
                    ...
                    DetailLine(
                        ...
                        value = allocation.collectionName,
...
@Composable
private fun AdvertisingAllocateVisitorScreenPreview() {
    AppScreenPreview {
